...
import com.reservation.models.security.oauthuser.OAuth2UserInfo;
import com.reservation.models.security.oauthuser.OAuth2UserInfoFactory;
...
public class CustomOauth2UserService extends DefaultOAuth2UserService {
	...
	private OAuth2User processOAuth2User (OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
		OAuth2UserInfo oAuth2UserInfo = OAuth2UserInfoFactory
				.geAuth2UserInfo(oAuth2UserRequest.getClientRegistration().getRegistrationId(), oAuth2User.getAttributes());
		...
		if(user != null) {
			if(!user.getProvider().equals(AuthProvider.valueOf(oAuth2UserRequest.getClientRegistration().getRegistrationId()))) {
				throw new OAuth2AuthenticationProcessingException("Looks like you're signed up with " +
						user.getProviderId() + " account. Please use your " + user.getProvider());
			}
